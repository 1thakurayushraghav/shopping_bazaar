...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${
      isScrolled ? 'bg-black shadow-lg py-4' : 'bg-black/90 backdrop-blur-sm py-6'
    }`}>
...
<div className="text-2xl sm:text-3xl font-display font-bold">
  ...
  />
          ...
          <button
            ...
            className="md:hidden text-white hover:text-gold-400 transition-colors duration-300 text-2xl"
